...
const handleAddNewInvestment = async(req, res) => {
    try {
        ...
        const data = await db.query(
            `INSERT INTO invested_sip (sip_id, sip_name, amount_invested, frequency, platform, avg_interest) VALUES (?, ?, ?, ?, ?, ?)`, [sip_id, sip_name, amount_invested, frequency, platform, avg_interest]
        );
        if (!data) {
